...
> **No Signup · No Ads · No Watermarks · No Server Uploads**
...
- **🔄 Transform**: Quick 90-degree rotation and horizontal/vertical flipping.
- **🌙 Modern UI**: Clean "Zinc" design system with full dark mode support.
...
- **✨ New Feature**: Added Freeform Collage maker with rotation and layering.
- **🎨 UI/UX**: Unified design system with Zinc theme across all tabs.
- **🌍 Localization**: Full support for English, Korean, Chinese, and Japanese.
